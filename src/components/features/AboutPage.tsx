  ...
  return (
    <div className="min-h-screen overflow-y-auto transition-colors duration-300">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-her-dark/40 dark:text-her-cream/40 mb-10">
          Adaptive Interactive Visualization for AI/ML Concept Learning
        </p>

        {/* Abstract */}
        <Section title="Abstract">
          <p className="font-serif text-her-dark/60 dark:text-her-cream/60 leading-relaxed mb-3">
          ...
          <p className="font-serif text-her-dark/60 dark:text-her-cream/60 leading-relaxed">
        ...
        <Section title="Research Question">
          <p className="font-serif text-her-dark/60 dark:text-her-cream/60 leading-relaxed italic text-lg">
        ...
        <Section title="System Architecture">
          <div className="glass rounded-2xl p-6">
            <div className="flex flex-col gap-2">
              {[
                { label: 'Data Layer', desc: 'Curriculum graph (40 nodes, 5 tiers), quiz items, prerequisite DAG', color: '#3B82F6' },
                { label: 'Adaptive Engine', desc: 'BKT mastery tracking, SM-2 spaced repetition, difficulty adjuster, recommender', color: '#8B5CF6' },
                { label: 'Interaction Layer', desc: 'Knowledge graph (D3 force), 6 Canvas explorations, multi-format quizzes', color: '#EC4899' },
                { label: 'Learner State', desc: 'React Context store, localStorage persistence, session analytics', color: '#F59E0B' },
                { label: 'Presentation', desc: 'Responsive UI, dark mode, glass-morphism, particle background', color: '#10B981' },
              ].map((layer, i) => (
                <div key={i} className="flex items-center gap-3 py-2 border-b border-her-dark/5 dark:border-white/5 last:border-0">
                  <div className="w-3 h-3 rounded-full shrink-0" style={{ backgroundColor: layer.color }} />
                  <div>
                    <span className="text-sm font-medium text-her-dark dark:text-her-cream">{layer.label}</span>
                    <span className="text-xs text-her-dark/40 dark:text-her-cream/40 ml-2">{layer.desc}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <Section title="BKT Methodology">
          <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60 leading-relaxed mb-4">
          ...
          <ul className="space-y-1 text-sm text-her-dark/60 dark:text-her-cream/60 mb-4 ml-4">
          ...
          <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60 leading-relaxed mb-2">
          ...
          <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60 leading-relaxed">
        ...
        <Section title="Evaluation Plan">
          <div className="space-y-4">
            <div className="glass rounded-2xl p-4">
              <h3 className="font-medium text-her-dark dark:text-her-cream mb-1">A/B Testing</h3>
              <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60">
            ...
            <div className="glass rounded-2xl p-4">
              <h3 className="font-medium text-her-dark dark:text-her-cream mb-1">Think-Aloud Protocols</h3>
              <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60">
            ...
            <div className="glass rounded-2xl p-4">
              <h3 className="font-medium text-her-dark dark:text-her-cream mb-1">System Usability Scale (SUS)</h3>
              <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60">
            ...
            <div className="glass rounded-2xl p-4">
              <h3 className="font-medium text-her-dark dark:text-her-cream mb-1">Learning Analytics</h3>
              <p className="font-serif text-sm text-her-dark/60 dark:text-her-cream/60">
              ...
              <button
                ...
                className="mt-2 text-xs glass rounded-full text-her-dark/60 dark:text-her-cream/60 hover:text-her-red px-3 py-1.5 transition-colors"
              >
        ...
        <Section title="References">
          <ul className="space-y-2 text-sm text-her-dark/50 dark:text-her-cream/50">
        ...
        <div className="mt-12 pt-8 border-t border-her-dark/5 dark:border-white/5">
          <p className="text-sm text-her-dark/50 dark:text-her-cream/50">
            Built by{' '}
...
const Section: React.FC<{ title: string; children: React.ReactNode }> = ({ title, children }) => (
  <div className="mb-10">
    <h2 className="text-lg font-light tracking-[0.05em] text-her-dark dark:text-her-cream mb-4">{title}</h2>
    {children}
  </div>
);

const FrameworkCard: React.FC<{ title: string; author: string; description: string; color: string }> = ({
  title, author, description, color
}) => (
  <div className="glass rounded-2xl p-4 border-l-3" style={{ borderLeftColor: color, borderLeftWidth: 3 }}>
    <div className="flex items-baseline gap-2 mb-1">
      <h3 className="font-medium text-sm text-her-dark dark:text-her-cream">{title}</h3>
    </div>
    <p className="text-xs text-her-dark/40 dark:text-her-cream/40 mb-1">({author})</p>
    <p className="font-serif text-xs text-her-dark/60 dark:text-her-cream/60 leading-relaxed">{description}</p>
  </div>
);
