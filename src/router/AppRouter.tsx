...
const Clustering = lazy(() => import('../components/explorations/Clustering').then(m => ({ default: m.Clustering })));
...
function parseHash(hash: string): Route {
  ...
  if (h === 'about' || h === 'methodology') return { page: 'methodology' };
...
export const AppRouter: React.FC = () => {
  ...
  return (
    ...
    <Suspense fallback={<LoadingFallback />}>
          ...
          return (
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                ...
                <button onClick={() => navigate('/map')} className="bg-white/[0.10] border border-white/[0.10] text-white/80 rounded-full px-6 py-2.5 text-sm font-light">
                  Back to Map
                </button>
              </div>
            </div>
          ...
          <Suspense fallback={<LoadingFallback />}>
            <div className="h-full overflow-auto p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button onClick={() => navigate('/map')} className="text-[10px] uppercase tracking-[0.2em] text-white/30 hover:text-white/60 transition-colors">
                  Back to Map
                </button>
              </div>
      ...
      {route.page === 'methodology' && <AboutPage />}
